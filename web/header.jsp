<%-- 
    Document   : Header
    Created on : Feb 13, 2014, 9:10:31 AM
...
<html>
    <body>
        <div class="container">
            <header class="navbar navbar-inverse navbar-fixed-top" role="fixedHeader">

                <h1>António Rodrigues</h1>
                <dl>
                    ...
                    <a href="https://plus.google.com/u/0/+AntónioRodrigues0x51?rel=author" target="_blank" title="Google+ Profile"><img src="Imagens/google-logo-squareOrange.png" alt="Google plus icon"></a>
                    ...
                    <dt id="SocialMedia2">   <%@include file="SocialMedia.jsp" %></dt>
                    <dt id="links"> 
                    <a href ="FrontPage.jsp">FrontPage</a> 
                    <a href ="ControladorPersonalPage">Cv</a> 

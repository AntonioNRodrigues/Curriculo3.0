...
public class FillCurriculo {
    ...
    private void fillEducation() {
        ...
        edOverall.addEducation("2013", "Licenciatura em Engenharia Informática (Frequência)", "Introdução à Programação, Laboratórios de programação, Algoritmos e Estruturas de Dados, Lógica de Primeira Ordem, Introdução Investigação Operacional", "Faculdade de Ciências da Universidade de Lisboa");
    ...
    private void fillWorkExp() {
        ...
        wExperience.addExperience("De Outubro de 2012 a Junho de 2013",
                "Docente",
